...
import CanvasApp.ViewModel.Datas.PropertyData.Event.PropertyObserver;
...
public class PropertyView extends JPanel implements PropertyObserver {
    ...
    private void updateFields(PropertyData data) {
        System.out.printf(
    ...
    @Override
    public void onPropertyChanged(PropertyChanged event) {
